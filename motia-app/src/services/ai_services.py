...
class OllamaService:
    def __init__(self):
        self.client = ollama.AsyncClient(timeout=300.00)
    ...
    async def list_models(self) -> List[str]:
        try:
            ...
            print(f"Ollama list_models raw response: {models}")
...
class RAGService:
    def __init__(self, db_path: str = LANCEDB_PATH, ollama_service: OllamaService = None):
        ...
        self.ollama_service = ollama_service # Remove the 'or OllamaService()' part
        self.db = None
        self.table = None
...
# Instantiate services globally for singleton pattern
