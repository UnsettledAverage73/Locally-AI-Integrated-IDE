...
export default function SystemResources() {
  ...
  if (!stats) {
    return (
      <div className="@container">
        <div className="grid grid-cols-1 @[400px]:grid-cols-2 @[800px]:grid-cols-4 gap-4 animate-pulse">
          {[...Array(4)].map((_, i) => (
  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 @[400px]:grid-cols-2 @[800px]:grid-cols-4 gap-4">
        {/* CPU Card */}
        <Card>
